...
import { LucideCalendarDays, LucideClock, LucideMapPin, LucideTrophy } from '@lucide/angular';
...
@Component({
  ...
  imports: [LucideCalendarDays, LucideClock, LucideMapPin, LucideTrophy, StatusBadgeComponent],
  template: `
    <section class="world-banner" aria-labelledby="world-name">
      <div class="trophy-icon-wrap"><svg lucideTrophy width="60" height="60" /></div>
  ...
  styles: `
    ...
    .trophy-icon-wrap { align-content:center; aspect-ratio:1; background:rgba(232,180,50,.08); border:1px solid rgba(232,180,50,.3); border-radius:50%; color:#e8b432; display:grid; justify-items:center; position:relative; z-index:1; box-shadow: 0 0 20px rgba(232, 180, 50, 0.15); } .trophy-icon-wrap svg { stroke-width: 1.5; filter: drop-shadow(0 4px 6px rgba(0,0,0,.4)); }
    ...
    @media (max-width:700px) { .world-banner { gap:1rem; grid-template-columns:1fr 1fr; min-height:0; padding:1.2rem; } .trophy-icon-wrap { display:none; } .world-main { grid-column:span 2; } h1 { font-size:1.75rem; white-space:normal; } .banner-metric, .banner-status { border-left:0; border-top:1px solid rgba(255,255,255,.09); min-height:0; padding:1rem 0 0; } .banner-status { grid-column:auto; } .world-banner::after { display:none; } }
  `
})
